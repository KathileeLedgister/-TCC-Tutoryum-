const FILES_TO_CACHE = [
	...
	'images/icons/tumcoin-192x192.png',
	'images/icons/tumcoin-180x180.png',
	'images/icons/tumcoin-152x152.png',
	'images/icons/tumcoin-144x144.png',
	'images/icons/tumcoin-128x128.png',
	'images/icons/tumcoin-120x120.png',
	'images/icons/tumcoin-96x96.png',
 ...
 * fObj.direct === '0' - straight to the server don''t update cache
 * fObj.direct === '1' - to the server but update the cache
 * fObj.direct === '2' - from cache ONLY
 * fObj.direct === 'other' - cache first, if fail, then to the server
 * ====================================================================================
 */
...
var proccmd = function(event) {
	...
	} else if (typeof (fObj.direct) !== 'undefined') {
		switch (fObj.direct) {
			case '0':
				return fetch(event.request);
			case '1':
				return getRequest(event.request,
					{
						"cacheFirst": false, "cache": true, "defaultToCache": true,
...
self.addEventListener('push', function(event) {
	...
	event.waitUntil(
		...
		// as the body.
		self.registration.showNotification('TumCoin', {
			body: payload,
			badge: 'images/icons/tumcoin-128x128.png',
			icon: 'images/icons/tumcoin-128x128.png'
		})
	);
});
